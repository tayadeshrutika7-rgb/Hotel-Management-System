...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
        ...
        ImageIcon i1 = new ImageIcon("C:/intelji/new photo/sixth.jpg");
        Image i3 = i1.getImage().getScaledInstance(400,225,Image.SCALE_SMOOTH);
        ImageIcon i2 = new ImageIcon(i3);

        JLabel l1 = new JLabel(i2);
        l1.setBounds(300,0,400,225);
        ...
        c1.setBounds(130,82,120,25);
        contentPane.add(c1);

        ImageIcon i4 = new ImageIcon("C:/intelji/new photo/tick.png");
        Image i5 = i4.getImage().getScaledInstance(20, 20,Image.SCALE_DEFAULT);
                ImageIcon i6 = new ImageIcon(i5);
                JButton l2 = new JButton(i6);
        l2.setBounds(250,82,25,25);
